...
- [EyePop.ai](#eyepopai)
- [Micro AGI](#micro-agi)
- [DSLs for agentic projects](#dsls-for-agentic-projects)
- [Run agentic coders in a VM](#run-agentic-coders-in-a-vm)
- [LSP — if you're building an editor](#lsp--if-youre-building-an-editor)
- [BDD with Cucumber and Playwright](#bdd-with-cucumber-and-playwright)
- [Jest](#jest)
- [WordPress MCP server](#wordpress-mcp-server)
...
- Next OKTech event is a whole session on Nix — come along. — [OKTech — Nix event](https://www.meetup.com/oktech/events/314843644/)
